 ...
 * @author Redfield AB
 */
public class ConformalPredictionPlugin extends Plugin {
	// The shared instance.
	private static ConformalPredictionPlugin plugin;

	/**
	 * The constructor.
	 */
	public ConformalPredictionPlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static ConformalPredictionPlugin getDefault() {
		return plugin;
	}
