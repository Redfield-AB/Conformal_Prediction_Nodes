...
public class ConformalPredictorScorerRegressionNodeModel extends NodeModel {
	...
	private void validataSettings(DataTableSpec[] inSpecs) throws InvalidSettingsException {
		...
		ValidationUtil.validateColumnExists(PORT_INPUT_TABLE, inSpecs, getTargetColumn(), "Target");
		ValidationUtil.validateColumnExists(PORT_INPUT_TABLE, inSpecs, getLowerBoundColumnName(), "Lower bound");
		ValidationUtil.validateColumnExists(PORT_INPUT_TABLE, inSpecs, getUpperBoundColumnName(), "Upper bound");
	}
