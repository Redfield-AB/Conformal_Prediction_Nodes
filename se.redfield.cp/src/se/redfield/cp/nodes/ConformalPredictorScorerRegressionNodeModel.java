...
public class ConformalPredictorScorerRegressionNodeModel extends NodeModel {
	...
	private void validataSettings(DataTableSpec[] inSpecs) throws InvalidSettingsException {
		...
		ValidationUtil.validateDoubleColumn(PORT_INPUT_TABLE, inSpecs, getTargetColumn(), "Target");
		ValidationUtil.validateDoubleColumn(PORT_INPUT_TABLE, inSpecs, getLowerBoundColumnName(), "Lower bound");
		ValidationUtil.validateDoubleColumn(PORT_INPUT_TABLE, inSpecs, getUpperBoundColumnName(), "Upper bound");
	}
